...
void BuilderRegisterDescriptors()
{
    ...
    EBUS_EVENT(AssetBuilderSDK::AssetBuilderBus, RegisterComponentDescriptor, OpenDivaBuilder::BuilderPluginComponent::CreateDescriptor());
}
...
void BuilderAddComponents(AZ::Entity* entity)
{
    ...
    entity->CreateComponentIfReady<OpenDivaBuilder::BuilderPluginComponent>();
}
