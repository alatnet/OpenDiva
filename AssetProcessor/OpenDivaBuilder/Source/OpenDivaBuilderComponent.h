...
#ifndef OPENDIVABUILDER_H
#define OPENDIVABUILDER_H
...
namespace OpenDivaBuilder
{
    ...
    {
    public:
        AZ_COMPONENT(BuilderPluginComponent, "{2AE09797-F046-482E-BDB9-47BC9E2E8966}")
    ...
    private:
        OpenDivaBuilderWorker m_openDivaBuilder;
    };
}

#endif //OPENDIVABUILDER_H