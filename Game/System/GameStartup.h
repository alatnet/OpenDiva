...
namespace LYGame
{
     ...
     */
    class GameStartup : public IGameStartup, public ISystemEventListener, public IWindowMessageHandler
    {
    public:
         ...
         * /return a new instance of LyGame::OpenDivaGame() or nullptr if failed to initialize.
         */
        IGameRef Reset();
	...
	public:
		void ExecuteAutoExec(bool requireUserLogin /*= true*/);
    protected:
        GameStartup();
        virtual ~GameStartup();
